...
// INSERT POINT: _init
	...
	_start: function (e) {
		...
		// dirty hack to prevent scrolling using images in library
		if(this.wrapper.id === "outerLibrary" && e.target.tagName === "IMG") {
			return;
		}
		...
		utils.addEvent(this.options.bindToWrapper ? this.wrapper : window, 'mousemove', this);
		utils.addEvent(this.options.bindToWrapper ? this.wrapper : window, 'touchmove', this);
		utils.addEvent(this.options.bindToWrapper ? this.wrapper : window, 'MSPointerMove', this);
...
/* REPLACE END: _move */
	...
	_end: function (e) {
		...
		utils.removeEvent(this.options.bindToWrapper ? this.wrapper : window, 'mousemove', this);
		utils.removeEvent(this.options.bindToWrapper ? this.wrapper : window, 'touchmove', this);
		utils.removeEvent(this.options.bindToWrapper ? this.wrapper : window, 'MSPointerMove', this);
...
// INSERT POINT: _end
	...
	refresh: function (doNotReflow, scrollerHeight) {
		if(!arguments.length || this.wrapperHeight === 0) {
